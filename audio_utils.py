...
def normalize_audio(wav, sample_rate=None, normalize=True, strategy='loudness', peak_clip_headroom_db=1, rms_headroom_db=18, loudness_headroom_db=14,
                    loudness_compressor=True, log_clipping=True, stem_name=None):
    ...
    """
    if len(wav.shape) == 1: wav = wav[None]
